...
int main(){
    ...
    for(int i = 0; i < 5; i++){
        my_roster->print_average_days_in_course(my_roster->class_roster_array[i]->get("student_id"));
    }
    ...
    /*Making a call to my custom destructor to release the memory that was dynamically allocated in 
    the roster class*/
    my_roster->~Roster();
}
